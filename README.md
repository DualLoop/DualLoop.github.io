...
- `static/css/site.css`: base DualLoop styling; `gallery.css` adds the question-first header, gallery, and quiz. `nerfies.css`/`bulma.min.css` retain the template base.
...
The public repository is https://github.com/DualLoop/DualLoop.github.io.
GitHub Pages serves the root of `main` at https://dualloop.github.io.
...
This repository is the renamed project website. The previous website remains
unchanged in its original repository. Display names use DualLoop; historical
export paths, source record IDs, original programs, images, and hashes remain
unchanged. Publication links remain unset until supplied by the authors.
