...
def build(paper, reuse_tables=False):
    ...
    configs=[('coverage','appendix.tex','tab:discovery-evaluator-detail'),('generation','appendix.tex','tab:discovery-generation'),('evaluation','iclr2027_conference.tex','tab:discovery-generator-evaluation-preview'),('feedback','appendix.tex','tab:model-feedback-summary'),('transfer','appendix.tex','tab:sft-generated-transfer'),('external','appendix.tex','tab:sft-multisplit'),('heldout','appendix.tex','tab:sft-indistribution'),('direct','appendix.tex','tab:sft-direct'),('excluded','appendix.tex','tab:downstream-profile-holdout')]
    ...
    for suffix,subset in [('profile',rs('evaluation')[:6]),('steered',rs('evaluation')[6:])]:tables['evaluation-'+suffix]=table('evaluation-'+suffix,'Evaluator accuracy (%): '+('profile-conditioned' if suffix=='profile' else 'image-support-steered')+' discovery',headers,subset)
    ...
    for key,caption in [('transfer','Transfer to 252 model-feedback worlds · four fine-tuned checkpoints'),('heldout','Profile-conditioned test sets · four splits, 45 held-out worlds per split'),('direct','Direct training on model-feedback worlds · 50 held-out worlds, 250 instances')]:
