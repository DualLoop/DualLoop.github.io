...
def build_story_pages(root, detailed):
    ...
    def write(name,title,lead,body,extra=''):
        ...
        if name == 'programs.html':
            contents='<nav class="page-contents" aria-label="On this page"><a href="#programs">Program examples</a><a href="#verification">Image-replacement test</a><a href="#source-analysis">Source analysis</a><a href="#inverse-walkthroughs">Step-by-step walkthroughs</a></nav>'
        else:
